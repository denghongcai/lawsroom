...
func main(){
    ...
    n.Use(negroni.HandlerFunc(secure.New(secure.Options{
        ...
        ContentSecurityPolicy: "default-src 'self' 'unsafe-inline' 'unsafe-eval' blob: data: https://lawsroom.com wss://lawsroom.com https://file.txthinking.com https://fonts.googleapis.com https://fonts.gstatic.com https://www.google-analytics.com https://127.0.0.1",
    }).HandlerFuncWithNext))
    n.UseHandler(r)
