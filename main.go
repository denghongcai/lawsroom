...
func main(){
    ...
    n.Use(negroni.HandlerFunc(secure.New(secure.Options{
        ...
        ContentSecurityPolicy: "default-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://law.txthinking.com:444 wss://law.txthinking.com:444 https://fonts.googleapis.com https://fonts.gstatic.com https://127.0.0.1:444",
    }).HandlerFuncWithNext))
